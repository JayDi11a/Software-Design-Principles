...
/**
 * AccessTokens are used for authorization purposes.  Each {@link cscie97.asn4.housemate.entitlement.User} account
 * will have an AccessToken created for them when they login to the site.  Any future calls to restricted interface
 * methods on either the {@link cscie97.asn4.housemate.model.IHouseMateModelServieAPI} or
 * {@link cscie97.asn4.housemate.controller.IHouseMateConrollerServiceAPI} must pass the
 * {@link cscie97.asn4.housemate.entitlement.AccessToken#id} of the user's AccessToken in order to proceed.
...
public class AccessToken {
    ...
    /**
     * Sets when the token is no longer valid
     *
