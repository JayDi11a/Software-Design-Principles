...
/**
 * {@link cscie97.asn4.housemate.entitlement.User} objects may have multiple sets of credentials; a Credential
 * essentially consists of the username and password combination that a User will use to login and logout of the
 * {@link cscie97.asn4.housemate.entitlement.IEntitlementServiceAPI}, which will create an
 * {@link cscie97.asn4.housemate.entitlement.AccessToken} that they may use to carry out restricted interface
 * methods.  Users may then have multiple sets of usernames/passwords that they can use to log into the system.
 *
 * Passwords are hashed using the helper class {@link cscie97.asn4.housemate.entitlement.PasswordHash}.  At no time
 ...
 * @see cscie97.asn4.housemate.entitlement.PasswordHash
 */
