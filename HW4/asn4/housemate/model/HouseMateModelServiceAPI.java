...
import cscie97.asn4.knowledge.engine.QueryEngine;
...
import cscie97.asn4.housemate.exception.AuthTokenException;
 ...
 *
 */
public class HouseMateModelServiceAPI implements IHouseMateModelServiceAPI {

	private static final HouseMateModelServiceAPI INSTANCE = new HouseMateModelServiceAPI(); 
	 ...
	 */
	private HouseMateModelServiceAPI(){}	
	
	/**
	 * @return the singleton instance of HouseMateModelServiceAPI.
	 */
	public static HouseMateModelServiceAPI getInstance() {
        return INSTANCE;
    }
