...
/**
 * Exception for problems that might occur in any of the {@link cscie97.asn4.housemate.model},
 * {@link cscie97.asn4.housemate.controller}, or {@link cscie97.asn4.housemate.txt} classes. This class will wrap
...
public class HouseMateModelException extends Exception {
    ...
    /**
     * Wraps a more generic exception that may have been thrown in one of the txt importer classes or elsewhere
     ...
     */
    //public HuseMateModelException (String exceptionType, String line, int lineNum, String filename, Throwable cause) {
    public HouseMateModelException (String exceptionType, String line, int lineNum, String filename, Throwable cause) {
