 ...
 * @see 
 */
public class QueryEngineException extends HouseMateModelException {
     ...
     */
    public QueryEngineException (String line, int lineNum, String filename, Throwable cause) {
        super("QueryEngineException", line, lineNum, filename, cause);
    }
}
