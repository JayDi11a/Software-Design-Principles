 ...
 * @see 
 */
public class ImportException extends HouseMateModelException {

    /**
     * Wraps a more generic exception that may have been thrown in either {@link cscie97.asn4.ecommerce.csv.Importer} class. 
